      ...
      switch (_context.prev = _context.next) {
        case 0:
          ...
          promise = new Promise(function (resolve) {
            axios__WEBPACK_IMPORTED_MODULE_7___default()("http://127.0.0.1:7001/default/getArticleById?id:".concat(id)).then(function (res) {
              console.log(res);
              resolve(res.data);
            });
          });
...
//# sourceMappingURL=detailed.js.9a42b9c97a413e42acb5.hot-update.js.map