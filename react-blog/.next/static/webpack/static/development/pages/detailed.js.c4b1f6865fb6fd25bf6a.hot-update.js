...
Detailed.getInitialProps = function _callee() {
  var promise;
      ...
      switch (_context.prev = _context.next) {
        case 0:
          promise = new Promise(function (resolve) {
            axios__WEBPACK_IMPORTED_MODULE_7___default()('http://127.0.0.1:7001/default/getArticleById').then(function (res) {
              console.log(res);
              resolve(res.data);
            });
          });
...
//# sourceMappingURL=detailed.js.c4b1f6865fb6fd25bf6a.hot-update.js.map